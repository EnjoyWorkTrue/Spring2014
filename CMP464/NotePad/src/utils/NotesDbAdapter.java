...
public class NotesDbAdapter {
	...
	public long createNote(String title,String body,String TableName){
		ContentValues initialValues = new ContentValues();
		initialValues.put(KEY_TITLE, title);
		initialValues.put(KEY_BODY,body);
	...
	public Cursor fetchAllNotes(String tableName){
	...
	public Cursor fetchNote(String tableName,long rowId) throws SQLException {
	...
	public boolean updateNote(long rowId, String title, String body,String tableName) {
        ContentValues args = new ContentValues();
        args.put(KEY_TITLE, title);
        args.put(KEY_BODY, body);
	...
	public boolean updateNote(long rowId, String title,String tableName,int n) {
        ContentValues args = new ContentValues();
        args.put(KEY_TITLE, title);
